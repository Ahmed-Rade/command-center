...
const QUOTES_AR = [
"الجاهزية المستمرة عادة، لا صدفة.",
"كل عطل يعلّمك ما لا تعلّمه أي لوحة تحكم.",
"اشحن الإصلاح الصغير اليوم — لا تنتظر الحل المثالي.",
"السجل النظيف يعني عقلاً هادئاً.",
"أتمتة الأمور الروتينية تفرغك للأمور الصعبة.",
"أسرع إصلاح هو الذي لم تضطر لفعله أبداً.",
"وثّقها الآن — أنت في المستقبل مشغول بالفعل.",
"المراقبة الجيدة هي مجرد إنصات جيد، مؤتمت.",
"النسخ الاحتياطي رخيص. الندم ليس كذلك.",
"اقرأ رسالة الخطأ. غالباً تقول الحقيقة.",
"كل نظام تفهمه بعمق يصبح أداة تثق بها.",
"أفضل تنبيه هو الذي لم يحتج للانطلاق أبداً.",
"اجعل لوحة التحكم بسيطة — الوضوح يهزم الذكاء الزائد.",
"ما يُقاس يتحسّن.",
"عين ثانية تكشف الخطأ الذي فاتته عينك المتعبة.",
"نفسك في المستقبل ستشكرك على التعليق الذي كتبته اليوم.",
"التعقيد دَين — وشخص ما يدفع فائدته دائماً.",
"النظام الذي يفشل بصوت عالٍ ألطف من الذي يفشل بصمت.",
"تقرير الحادثة الجيد هدية لنفسك القادمة.",
"المرونة ليست تجنّب الفشل — بل التعافي أسرع من انتشاره.",
"الانضباط يتراكم أسرع من الحافز.",
"التكرار اليومي الصغير يهزم البطولات العرضية.",
"التقدّم يخفي نفسه داخل العمل المتكرر الممل.",
"الثبات يحوّل المهارة إلى سمعة.",
"خطّط للأيام السيئة، وابنِ للأيام الجيدة.",
"الصبر يتوسّع أفضل من الذعر.",
"البطء سلاسة، والسلاسة سرعة.",
"العمل الذي تقوم به دون أن يراك أحد يحدّد سقف كل شيء آخر.",
"الإتقان هو فقط عادات المبتدئ، لكن لمدة أطول.",
"أنت لا ترتقي إلى أهدافك، بل تسقط إلى مستوى أنظمتك.",
"الراحة والنمو نادراً ما يشتركان في نفس الغرفة.",
"الطاقة تتبع الانتباه — احرس ما تنظر إليه.",
"المعيار الذي تتجاهله هو المعيار الذي تقبله.",
"المنجَز اليوم يهزم الكامل يوماً ما.",
"العادة الفائتة مرة حادثة، وفائتة مرتين نمط.",
"الراحة جزء من عملية البناء، لا استراحة منها.",
"أكثر التوتر هو انتباه بلا مسار.",
"لا يمكنك السحب من نظام لم تنسخه احتياطياً أبداً.",
"الأيام الهادئة تبني القوة التي تتطلّبها الأيام الصاخبة.",
"ليست كل مشكلة بحاجة للحل الليلة.",
"الوضوح يأتي من الفعل، أكثر بكثير من التفكير.",
"العقل، كالخادم، يحتاج صيانة مجدولة.",
"القلق عملية تعمل بلا مخرجات.",
"بعض الأحمال يجب أن توضع، لا أن تُحمل.",
"القوة قرار هادئ متكرر — لا قرار دراميّ واحد.",
"يُسمح لك أن تتحرّك بتمهّل وأنت لا تزال تتقدّم.",
"الجسم في حركة يغيّر الحالة المزاجية التي تقوده.",
"ما تتسامح معه، تُعلّم الآخرين تكراره.",
"طلب المساعدة قرار تصميم نظام، لا ضعف.",
"كل نسخة منك واصلت المسير لا تزال موجودة هنا.",
"اختبر في بيئة التجربة ما لا يمكنك تحمّل كسره في الإنتاج.",
"الإعداد الذي لم تكتبه أنت هو الذي ينهار في الثالثة فجراً.",
"المتغيّر المسمّى جيداً يوفّر جلسة تصحيح مستقبلية.",
"التكرار وسواس قهري بجدول صيانة.",
"السبب الجذري نادراً ما يكون حيث ظهرت العَرَض.",
"التحكّم بالإصدارات ليس بيروقراطية — بل ذاكرة تثق بها.",
"حسّن من أجل المهندس الذي سيرث هذا، لا فقط من أجل الآن.",
"دفتر التشغيل المكتوب بهدوء يُقرأ بهدوء وقت الفوضى.",
"التأخر يختبئ حتى يقيسه أحد أخيراً.",
"أبسط بنية تعمل هي الصحيحة — في الوقت الراهن.",
"الحافز يبدأك. البنية التحتية تستمر بك.",
"الطفرات الكبيرة هي فقط خطوات صغيرة توقفت عن عدّها.",
"ما تكرره، تصبحه — عمداً أو عرضاً.",
"النسخة المملة من الخطة عادة هي التي تُشحن.",
"المهارة هي فقط صبر تعلّم قراءة الوثائق.",
"كل خبير كان متوسطاً يوماً، فقط لمدة أطول مما يعترف.",
"لا تحتاج وقتاً أكثر، بل تشتيتاً أقل يعمل في الخلفية.",
"أصعب جزء في أي مهمة هو فتح الملف الأول.",
"الانضباط هو اختيار ما تريده أكثر على ما تريده الآن.",
"التحسّن غير مرئي يومياً وواضح سنوياً.",
"العقل الهادئ يعالج طلبات أكثر من العقل القلق.",
"الاحتراق هو فقط حِمل غير معالَج مع الوقت.",
"يُسمح لك أن تسجّل خروجك — القائمة ستبقى هناك غداً.",
"بعض الأيام الفوز هو فقط البقاء متصلاً.",
"المقارنة عملية لا تعيد نتيجة مفيدة أبداً.",
"الصوت الذي يقول 'غير كافٍ' نادراً ما يستشهد ببيانات حقيقية.",
"الراحة ليست جزاء على الإنجاز — بل جزء من البناء.",
"أكثر القلق هو عقلك يشغّل محاكاة بمدخلات سيئة.",
"أنت لست متأخراً. أنت تماماً حيث أوصلك طريقك.",
"التعافي، كالنشر، نادراً ما يسير في خط مستقيم.",
"حب الاستطلاع هو المصحّح الوحيد الذي لا يتعب أبداً.",
"اسأل السؤال الغبي قبل الخطأ المكلف.",
"أسرع طريقة لتعلّم نظام هي كسره بلطف.",
"كل رسالة خطأ درس صغير، يُعطى على مضض.",
"بقَ مبتدئاً في شيء — هذا يحافظ على حِدّة باقيك.",
"اقرأ الوثائق مرة كاملة قبل أن تحتاجها بشدة.",
"الفهم يهزم الحفظ — أحدهما ينجو من التحديث، والآخر لا.",
"الخبير كان يوماً الشخص الذي استمر في سؤال لماذا.",
"تبويب واحد مغلق هو قرار واحد أقل يجذب انتباهك.",
"الزخم هش في الصباح وعنيد عند الظهيرة.",
"العمل العميق يبدأ في اللحظة التي تتوقف فيها الإشعارات عن الفوز.",
"الطاقة المُنفقة في تبديل المهام طاقة لم تبنِ شيئاً.",
"مهمة قصيرة تُنجز الآن تهزم مهمة كبيرة مخطّطة للأبد.",
"أول عشر دقائق تحدّد الساعتين التاليتين.",
"احمِ الساعة الأولى — فهي تحدّد نغمة كل ما يليها.",
"التقدّم يفضّل ممراً ضيقاً على حقل مفتوح.",
"جودة انتباهك هي جودة عملك.",
"الملل هو العقل يطلب مشكلة أصعب.",
"كل اختصار دَين ستدفع فائدته يوماً.",
"الفجوة بين من أنت ومن تريد أن تكون تُسمّى عملاً.",
"الضغط لا يبني الشخصية — بل يكشفها.",
"ما تقاومه، تحمله. ما تتقبّله، يمكنك تحريكه.",
"الشخص الذي تصبحه سيشكرك على القرار الذي اتخذته اليوم.",
"لديك وقت أكثر مما تظن، وأقل مما تشعر.",
"الضمير الصافي يتحرّك بسرعة.",
"أفضل وقت للراحة كان قبل الإرهاق. وثاني أفضل وقت هو الآن.",
"السكون ليس فراغاً — بل المكان الذي تخفى فيه الإشارة الحقيقية.",
"الأشياء التي تستحق الحصول عليها نادراً ما تكون ما وُعدت به.",
"التركيز ليس فعل المزيد — بل قول لا لكل شيء تقريباً.",
"المحادثات الصعبة عمرها أقصر من المحادثات المتجنَّبة.",
"ما يبدو كسلاً غالباً خوف يرتدي ثياباً مريحة.",
"الصمت أعلى ردّ على أشياء لا تستحق ردّاً.",
"نسختك بعد عشر سنوات تُبنى من خيارات تبدو صغيرة اليوم.",
"ليس كل ما تكسّر يحتاج إصلاحاً. بعض الأشياء تحتاج تركاً.",
"الوضوح حول ما يهم هو أندر أشكال الذكاء.",
"آراء قوية، محمولة بخفّة — هذا التوازن يستحق السعي إليه.",
"لا تحتاج إذناً للبدء. تحتاج فقط أن تتوقف عن انتظاره.",
"العمل يفضح العامل. ظهور بصدق.",
"كل صعب يصبح قصة. كل متجنَّب يصبح عبئاً.",
"الألم معلومة. المعاناة هي القصة التي تضيفها إليه.",
"من تكون في الخصوصية يصبح في النهاية من تكون في كل مكان.",
"العقل القادر على الجلوس مع الشك أقوى من العقل الذي يحتاج أجوبة.",
"الثقة تُبنى في لحظات لم يكن أحد يراقب فيها.",
"أنت حاصل جمع كل ردّ قدّمته حين لم يكن أحد يراقب.",
"أهم القرارات تبدو الأقل إلحاحاً.",
"مستقبلك لا يُوجَد — بل يُصنع، تشتيتاً مهملاً تلو الآخر.",
"لا شيء يدوم للأبد إلا أثر ما اخترت أن تهتم به.",
"أعلى صوت في الغرفة نادراً ما يحمل أعمق فكرة.",
"العمق يُبنى في الصمت. والسعة تُبنى في الانكشاف. تحتاج كلاهما.",
"ثمن العقل الصافي يُدفع في محادثات صعبة.",
"بعض الأبواب تُفتح فقط من الداخل.",
"لا يمكنك العودة وتغيير البداية. يمكنك أن تبدأ من حيث أنت وتغيّر النهاية.",
"ما تسمّيه مستحيلاً غالباً مجرد غير مألوف.",
"السؤال الصحيح أقوى دائماً من الجواب الصحيح.",
"الندم هو الضريبة على اللعب بأمان.",
];
